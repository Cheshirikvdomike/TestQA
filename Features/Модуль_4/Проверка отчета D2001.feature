...
Функционал: Проверка отображения возвратов в отчёте D2001 Продажи

Как тестировщик я хочу
протестировать отчет 
чтобы проверить верные данные в отчете   
...
*Сверка отчета с макетом
	И Табличный документ "Result" равен макету "Макет для D2001" по шаблону